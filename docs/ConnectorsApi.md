...
<a name="connectConnectorWithParameters"></a>
# **connectConnectorWithParameters**
> ConnectorInstruction connectConnectorWithParameters(connectorNamedisplayName, key, placeholder, type, usePopup, opts)
...
apiInstance.connectConnectorWithParameters(connectorNamedisplayName, key, placeholder, type, usePopup, opts, callback);
```
