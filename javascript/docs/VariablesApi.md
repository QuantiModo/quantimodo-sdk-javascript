...
let apiInstance = new quantimodo-api.VariablesApi();
...
let variableId = new quantimodo-api.UserVariableDelete(); // UserVariableDelete | Id of the variable whose measurements should be deleted


apiInstance.deleteUserVariable(variableId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let body = new quantimodo-api.UserTag(); // UserTag | Contains the new user tag data
...
let userVariables = [new quantimodo-api.Variable()]; // [Variable] | Variable user settings data
...
apiInstance.postUserVariables(userVariables, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.resetUserVariableSettings(variableId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
