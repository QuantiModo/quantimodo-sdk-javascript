...
export default class VariablesApi {
    ...
    */
     ...
     */
    deleteUserVariable(variableId, callback) {
      let postBody = variableId;
     ...
     * data is of type: {@link module:model/CommonResponse}
     */
    postUserVariables(userVariables, opts, callback) {
      opts = opts || {};
      let postBody = userVariables;
     ...
     */
    resetUserVariableSettings(variableId, callback) {
      let postBody = variableId;
