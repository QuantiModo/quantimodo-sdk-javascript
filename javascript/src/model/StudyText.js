...
* @version 2.0
*/
export default class StudyText {
    /**
    ...
    */
    ...
    constructor(studyAbstract, studyDesign, studyLimitations, studyObjective, studyResults, studyTitle) {
        ...
        this['studyAbstract'] = studyAbstract;this['studyDesign'] = studyDesign;this['studyLimitations'] = studyLimitations;this['studyObjective'] = studyObjective;this['studyResults'] = studyResults;this['studyTitle'] = studyTitle;
    ...
    */
    averageEffectFollowingHighCauseExplanation = undefined;
    /**
    ...
    */
    averageEffectFollowingLowCauseExplanation = undefined;
    /**
    ...
    */
    significanceExplanation = undefined;
    /**
    * Ex: Aggregated data from 21 suggests with a low degree of confidence (p=0.097) that Very Distracting Time (Work) has a moderately positive predictive relationship (R=0.354) with Video Activities  (Activity).  The highest quartile of Video Activities measurements were observed following an average 2.03h Very Distracting Timeper day.  The lowest quartile of Video Activities  measurements were observed following an average 1.04h Very Distracting Timeper day.
    * @member {String} studyAbstract
    */
    studyAbstract = undefined;
    /**
