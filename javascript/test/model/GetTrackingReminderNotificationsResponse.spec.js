...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new quantimodo-api.GetTrackingReminderNotificationsResponse();
  });
  ...
  describe('GetTrackingReminderNotificationsResponse', function() {
    it('should create an instance of GetTrackingReminderNotificationsResponse', function() {
      ...
      //var instane = new quantimodo-api.GetTrackingReminderNotificationsResponse();
      //expect(instance).to.be.a(quantimodo-api.GetTrackingReminderNotificationsResponse);
    });
