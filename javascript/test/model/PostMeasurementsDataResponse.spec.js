...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new quantimodo-api.PostMeasurementsDataResponse();
  });
  ...
  describe('PostMeasurementsDataResponse', function() {
    it('should create an instance of PostMeasurementsDataResponse', function() {
      ...
      //var instane = new quantimodo-api.PostMeasurementsDataResponse();
      //expect(instance).to.be.a(quantimodo-api.PostMeasurementsDataResponse);
    });
