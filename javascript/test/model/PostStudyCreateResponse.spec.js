...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new quantimodo-api.PostStudyCreateResponse();
  });
  ...
  describe('PostStudyCreateResponse', function() {
    it('should create an instance of PostStudyCreateResponse', function() {
      ...
      //var instane = new quantimodo-api.PostStudyCreateResponse();
      //expect(instance).to.be.a(quantimodo-api.PostStudyCreateResponse);
    });
