...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantimodoApi.TrackingReminderNotification();
  });
  ...
  describe('TrackingReminderNotification', function() {
    it('should create an instance of TrackingReminderNotification', function() {
      ...
      //var instane = new QuantimodoApi.TrackingReminderNotification();
      //expect(instance).to.be.a(QuantimodoApi.TrackingReminderNotification);
    });
