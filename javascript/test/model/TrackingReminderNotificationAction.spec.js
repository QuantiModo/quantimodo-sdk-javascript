...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new quantimodo-api.TrackingReminderNotificationAction();
  });
  ...
  describe('TrackingReminderNotificationAction', function() {
    it('should create an instance of TrackingReminderNotificationAction', function() {
      ...
      //var instane = new quantimodo-api.TrackingReminderNotificationAction();
      //expect(instance).to.be.a(quantimodo-api.TrackingReminderNotificationAction);
    });
