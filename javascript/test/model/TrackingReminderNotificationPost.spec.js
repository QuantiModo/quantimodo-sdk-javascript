...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new quantimodo-api.TrackingReminderNotificationPost();
  });
  ...
  describe('TrackingReminderNotificationPost', function() {
    it('should create an instance of TrackingReminderNotificationPost', function() {
      ...
      //var instane = new quantimodo-api.TrackingReminderNotificationPost();
      //expect(instance).to.be.a(quantimodo-api.TrackingReminderNotificationPost);
    });
