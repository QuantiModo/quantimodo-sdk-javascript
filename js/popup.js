...
let ratingPopupHeight; let ratingPopupWidth
let qmPopup = {
...
var onFaceButtonClicked = function(){
    ...
    let ratingValue // Figure out what rating was selected
    ...
    function showLastValuesSection() {
        function setLastValueButtonProperties(textElement, buttonElement, notificationAction) {
            if (notificationAction.modifiedValue !== null) {
                ...
                let size = 30 - notificationAction.shortTitle.length * 12 / 3
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    let wDiff = (380 - window.innerWidth)
    let hDiff = (70 - window.innerHeight)
