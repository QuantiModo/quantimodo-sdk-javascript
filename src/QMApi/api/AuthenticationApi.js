...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QMApi.AuthenticationApi = factory(root.QMApi.ApiClient);
  }
   ...
   * @module QMApi/api/AuthenticationApi
   * @version 5.8.725
   */

  /**
   * Constructs a new AuthenticationApi. 
   * @alias module:QMApi/api/AuthenticationApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:QMApi/api/AuthenticationApi~getAccessTokenCallback
     ...
     * @param {module:QMApi/api/AuthenticationApi~getAccessTokenCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:QMApi/api/AuthenticationApi~getOauthAuthorizationCodeCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.redirectUri The redirect URI is the URL within your client application that will receive the OAuth2 credentials.
     * @param {String} opts.state An opaque string that is round-tripped in the protocol; that is to say, it is returned as a URI parameter in the Basic flow, and in the URI
     * @param {module:QMApi/api/AuthenticationApi~getOauthAuthorizationCodeCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:QMApi/api/AuthenticationApi~getSocialAuthorizationCodeCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:QMApi/api/AuthenticationApi~getSocialAuthorizationCodeCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:QMApi/api/AuthenticationApi~getSocialAuthorizationTokenCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:QMApi/api/AuthenticationApi~getSocialAuthorizationTokenCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:QMApi/api/AuthenticationApi~getSocialLoginPageCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} provider The current options are &#x60;google&#x60; and &#x60;facebook&#x60;.
     * @param {module:QMApi/api/AuthenticationApi~getSocialLoginPageCallback} callback The callback function, accepting three arguments: error, data, response
     */
