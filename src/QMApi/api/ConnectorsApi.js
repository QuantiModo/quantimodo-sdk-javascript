...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['QMApi/ApiClient', 'QMApi/model/Connector', 'QMApi/model/ConnectorInstruction'], factory);
  ...
  /**
   * Connectors service.
   * @module QMApi/api/ConnectorsApi
   * @version 5.8.725
   */

  /**
   * Constructs a new ConnectorsApi. 
   * @alias module:QMApi/api/ConnectorsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:QMApi/api/ConnectorsApi~connectConnectorCallback
     ...
     * @param {module:QMApi/api/ConnectorsApi~connectConnectorCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:QMApi/api/ConnectorsApi~connectConnectorWithParametersCallback
     * @param {String} error Error message, if any.
     * @param {module:QMApi/model/ConnectorInstruction} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:QMApi/api/ConnectorsApi~connectConnectorWithParametersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:QMApi/model/ConnectorInstruction}
     */
     ...
     * @callback module:QMApi/api/ConnectorsApi~disconnectConnectorCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} connectorName Lowercase system name of the source application or device. Get a list of available connectors from the /v1/connectors/list endpoint.
     * @param {module:QMApi/api/ConnectorsApi~disconnectConnectorCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:QMApi/api/ConnectorsApi~getConnectorsListCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:QMApi/model/Connector>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:QMApi/api/ConnectorsApi~getConnectorsListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:QMApi/model/Connector>}
     */
     ...
     * @callback module:QMApi/api/ConnectorsApi~getIntegrationJsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:QMApi/api/ConnectorsApi~getIntegrationJsCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:QMApi/api/ConnectorsApi~getMobileConnectPageCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.userId User&#39;s id
     * @param {module:QMApi/api/ConnectorsApi~getMobileConnectPageCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:QMApi/api/ConnectorsApi~updateConnectorCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.userId User&#39;s id
     * @param {module:QMApi/api/ConnectorsApi~updateConnectorCallback} callback The callback function, accepting three arguments: error, data, response
     */
