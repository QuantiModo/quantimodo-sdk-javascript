...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['QMApi/ApiClient', 'QMApi/model/CommonResponse', 'QMApi/model/UserTag', 'QMApi/model/UserVariableDelete', 'QMApi/model/UserVariables', 'QMApi/model/Variable', 'QMApi/model/VariableCategory'], factory);
  ...
  /**
   * Variables service.
   * @module QMApi/api/VariablesApi
   * @version 5.8.725
   */

  /**
   * Constructs a new VariablesApi. 
   * @alias module:QMApi/api/VariablesApi
   * @class
   * @param {module:QMApi/ApiClient} apiClient Optional API client implementation to use,
   * default to {@link module:QMApi/ApiClient#instance} if unspecified.
   */
  var exports = function(apiClient) {
     ...
     * @callback module:QMApi/api/VariablesApi~deleteUserTagCallback
     * @param {String} error Error message, if any.
     * @param {module:QMApi/model/CommonResponse} data The data returned by the service call.
     ...
     * @param {module:QMApi/api/VariablesApi~deleteUserTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:QMApi/model/CommonResponse}
     */
     ...
     * @callback module:QMApi/api/VariablesApi~deleteUserVariableCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:QMApi/model/UserVariableDelete} variableId Id of the variable whose measurements should be deleted
     * @param {module:QMApi/api/VariablesApi~deleteUserVariableCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:QMApi/api/VariablesApi~getPublicVariablesCallback
     * @param {String} error Error message, if any.
     * @param {module:QMApi/model/Variable} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:QMApi/api/VariablesApi~getPublicVariablesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:QMApi/model/Variable}
     */
     ...
     * @callback module:QMApi/api/VariablesApi~getUserVariablesCallback
     * @param {String} error Error message, if any.
     * @param {module:QMApi/model/Variable} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.offset OFFSET says to skip that many rows before beginning to return rows to the client. OFFSET 0 is the same as omitting the OFFSET clause.If both OFFSET and LIMIT appear, then OFFSET rows are skipped before starting to count the LIMIT rows that are returned.
     * @param {String} opts.sort Sort by one of the listed field names. If the field name is prefixed with &#x60;-&#x60;, it will sort in descending order.
     * @param {module:QMApi/api/VariablesApi~getUserVariablesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:QMApi/model/Variable}
     */
     ...
     * @callback module:QMApi/api/VariablesApi~getVariableCategoriesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:QMApi/model/VariableCategory>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:QMApi/api/VariablesApi~getVariableCategoriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:QMApi/model/VariableCategory>}
     */
     ...
     * @callback module:QMApi/api/VariablesApi~postUserTagsCallback
     * @param {String} error Error message, if any.
     * @param {module:QMApi/model/CommonResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:QMApi/model/UserTag} body Contains the new user tag data
     * @param {Object} opts Optional parameters
     * @param {Number} opts.userId User&#39;s id
     * @param {module:QMApi/api/VariablesApi~postUserTagsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:QMApi/model/CommonResponse}
     */
     ...
     * @callback module:QMApi/api/VariablesApi~postUserVariablesCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:QMApi/model/UserVariables} userVariables Variable user settings data
     * @param {module:QMApi/api/VariablesApi~postUserVariablesCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:QMApi/api/VariablesApi~resetUserVariableSettingsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Reset user settings for a variable to defaults
     * @param {module:QMApi/model/UserVariableDelete} variableId Id of the variable that should be reset
     * @param {module:QMApi/api/VariablesApi~resetUserVariableSettingsCallback} callback The callback function, accepting three arguments: error, data, response
     */
