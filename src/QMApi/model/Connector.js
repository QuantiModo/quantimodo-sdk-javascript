...
(function(root, factory) {
   ...
   * @module QMApi/model/Connector
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>Connector</code>.
   * @alias module:QMApi/model/Connector
   * @class
   ...
   * @param {module:QMApi/model/Connector} obj Optional instance to populate.
   * @return {module:QMApi/model/Connector} The populated <code>Connector</code> instance.
   */
