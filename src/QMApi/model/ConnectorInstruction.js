...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QMApi.ConnectorInstruction = factory(root.QMApi.ApiClient);
  }
   ...
   * @module QMApi/model/ConnectorInstruction
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>ConnectorInstruction</code>.
   * @alias module:QMApi/model/ConnectorInstruction
   * @class
   */
   ...
   * @param {module:QMApi/model/ConnectorInstruction} obj Optional instance to populate.
   * @return {module:QMApi/model/ConnectorInstruction} The populated <code>ConnectorInstruction</code> instance.
   */
