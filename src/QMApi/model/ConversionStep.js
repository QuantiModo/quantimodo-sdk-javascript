...
(function(root, factory) {
   ...
   * @module QMApi/model/ConversionStep
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>ConversionStep</code>.
   * @alias module:QMApi/model/ConversionStep
   * @class
   * @param operation {module:QMApi/model/ConversionStep.OperationEnum} ADD or MULTIPLY
   ...
   * @param {module:QMApi/model/ConversionStep} obj Optional instance to populate.
   * @return {module:QMApi/model/ConversionStep} The populated <code>ConversionStep</code> instance.
   */
  ...
  /**
   * ADD or MULTIPLY
   * @member {module:QMApi/model/ConversionStep.OperationEnum} operation
   */
