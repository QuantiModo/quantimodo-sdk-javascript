...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QMApi.Correlation = factory(root.QMApi.ApiClient);
  }
   ...
   * @module QMApi/model/Correlation
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>Correlation</code>.
   * @alias module:QMApi/model/Correlation
   * @class
   ...
   * @param {module:QMApi/model/Correlation} obj Optional instance to populate.
   * @return {module:QMApi/model/Correlation} The populated <code>Correlation</code> instance.
   */
