...
(function(root, factory) {
   ...
   * @module QMApi/model/JsonErrorResponse
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>JsonErrorResponse</code>.
   * @alias module:QMApi/model/JsonErrorResponse
   * @class
   ...
   * @param {module:QMApi/model/JsonErrorResponse} obj Optional instance to populate.
   * @return {module:QMApi/model/JsonErrorResponse} The populated <code>JsonErrorResponse</code> instance.
   */
