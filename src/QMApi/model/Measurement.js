...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QMApi.Measurement = factory(root.QMApi.ApiClient);
  }
   ...
   * @module QMApi/model/Measurement
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>Measurement</code>.
   * @alias module:QMApi/model/Measurement
   * @class
   ...
   * @param {module:QMApi/model/Measurement} obj Optional instance to populate.
   * @return {module:QMApi/model/Measurement} The populated <code>Measurement</code> instance.
   */
