...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QMApi.MeasurementDelete = factory(root.QMApi.ApiClient);
  }
   ...
   * @module QMApi/model/MeasurementDelete
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>MeasurementDelete</code>.
   * @alias module:QMApi/model/MeasurementDelete
   * @class
   ...
   * @param {module:QMApi/model/MeasurementDelete} obj Optional instance to populate.
   * @return {module:QMApi/model/MeasurementDelete} The populated <code>MeasurementDelete</code> instance.
   */
