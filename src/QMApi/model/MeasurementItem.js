...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QMApi.MeasurementItem = factory(root.QMApi.ApiClient);
  }
   ...
   * @module QMApi/model/MeasurementItem
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>MeasurementItem</code>.
   * @alias module:QMApi/model/MeasurementItem
   * @class
   ...
   * @param {module:QMApi/model/MeasurementItem} obj Optional instance to populate.
   * @return {module:QMApi/model/MeasurementItem} The populated <code>MeasurementItem</code> instance.
   */
