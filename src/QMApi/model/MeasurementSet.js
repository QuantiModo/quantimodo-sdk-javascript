...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['QMApi/ApiClient', 'QMApi/model/MeasurementItem'], factory);
   ...
   * @module QMApi/model/MeasurementSet
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>MeasurementSet</code>.
   * @alias module:QMApi/model/MeasurementSet
   * @class
   * @param measurementItems {Array.<module:QMApi/model/MeasurementItem>} Array of timestamps, values, and optional notes
   ...
   * @param {module:QMApi/model/MeasurementSet} obj Optional instance to populate.
   * @return {module:QMApi/model/MeasurementSet} The populated <code>MeasurementSet</code> instance.
   */
   ...
   * @member {Array.<module:QMApi/model/MeasurementItem>} measurementItems
   */
   ...
   * @member {module:QMApi/model/MeasurementSet.CombinationOperationEnum} combinationOperation
   */
