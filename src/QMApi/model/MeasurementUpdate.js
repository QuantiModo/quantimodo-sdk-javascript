...
(function(root, factory) {
   ...
   * @module QMApi/model/MeasurementUpdate
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>MeasurementUpdate</code>.
   * @alias module:QMApi/model/MeasurementUpdate
   * @class
   ...
   * @param {module:QMApi/model/MeasurementUpdate} obj Optional instance to populate.
   * @return {module:QMApi/model/MeasurementUpdate} The populated <code>MeasurementUpdate</code> instance.
   */
