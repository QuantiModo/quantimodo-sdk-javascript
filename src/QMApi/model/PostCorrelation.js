...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QMApi.PostCorrelation = factory(root.QMApi.ApiClient);
  }
   ...
   * @module QMApi/model/PostCorrelation
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>PostCorrelation</code>.
   * @alias module:QMApi/model/PostCorrelation
   * @class
   ...
   * @param {module:QMApi/model/PostCorrelation} obj Optional instance to populate.
   * @return {module:QMApi/model/PostCorrelation} The populated <code>PostCorrelation</code> instance.
   */
