...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QMApi.TrackingReminder = factory(root.QMApi.ApiClient);
  }
   ...
   * @module QMApi/model/TrackingReminder
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>TrackingReminder</code>.
   * @alias module:QMApi/model/TrackingReminder
   * @class
   ...
   * @param {module:QMApi/model/TrackingReminder} obj Optional instance to populate.
   * @return {module:QMApi/model/TrackingReminder} The populated <code>TrackingReminder</code> instance.
   */
   ...
   * @member {module:QMApi/model/TrackingReminder.CombinationOperationEnum} combinationOperation
   */
