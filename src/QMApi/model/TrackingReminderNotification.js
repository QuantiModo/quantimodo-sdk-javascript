...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QMApi.TrackingReminderNotification = factory(root.QMApi.ApiClient);
  }
   ...
   * @module QMApi/model/TrackingReminderNotification
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>TrackingReminderNotification</code>.
   * @alias module:QMApi/model/TrackingReminderNotification
   * @class
   ...
   * @param {module:QMApi/model/TrackingReminderNotification} obj Optional instance to populate.
   * @return {module:QMApi/model/TrackingReminderNotification} The populated <code>TrackingReminderNotification</code> instance.
   */
   ...
   * @member {module:QMApi/model/TrackingReminderNotification.CombinationOperationEnum} combinationOperation
   */
