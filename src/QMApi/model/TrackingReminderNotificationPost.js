...
(function(root, factory) {
   ...
   * @module QMApi/model/TrackingReminderNotificationPost
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>TrackingReminderNotificationPost</code>.
   * @alias module:QMApi/model/TrackingReminderNotificationPost
   * @class
   * @param id {Number} Id of the TrackingReminderNotification
   * @param action {module:QMApi/model/TrackingReminderNotificationPost.ActionEnum} track records a measurement for the notification.  snooze changes the notification to 1 hour from now. skip deletes the notification.
   */
   ...
   * @param {module:QMApi/model/TrackingReminderNotificationPost} obj Optional instance to populate.
   * @return {module:QMApi/model/TrackingReminderNotificationPost} The populated <code>TrackingReminderNotificationPost</code> instance.
   */
   ...
   * @member {module:QMApi/model/TrackingReminderNotificationPost.ActionEnum} action
   */
