...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['QMApi/ApiClient', 'QMApi/model/ConversionStep'], factory);
   ...
   * @module QMApi/model/Unit
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>Unit</code>.
   * @alias module:QMApi/model/Unit
   * @class
   * @param name {String} Unit name
   * @param abbreviatedName {String} Unit abbreviation
   * @param category {module:QMApi/model/Unit.CategoryEnum} Unit category
   * @param conversionSteps {Array.<module:QMApi/model/ConversionStep>} Conversion steps list
   */
   ...
   * @param {module:QMApi/model/Unit} obj Optional instance to populate.
   * @return {module:QMApi/model/Unit} The populated <code>Unit</code> instance.
   */
  ...
  /**
   * Unit category
   * @member {module:QMApi/model/Unit.CategoryEnum} category
   */
   ...
   * @member {Array.<module:QMApi/model/ConversionStep>} conversionSteps
   */
