...
(function(root, factory) {
   ...
   * @module QMApi/model/Update
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>Update</code>.
   * @alias module:QMApi/model/Update
   * @class
   ...
   * @param {module:QMApi/model/Update} obj Optional instance to populate.
   * @return {module:QMApi/model/Update} The populated <code>Update</code> instance.
   */
