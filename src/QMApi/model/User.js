...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QMApi.User = factory(root.QMApi.ApiClient);
  }
   ...
   * @module QMApi/model/User
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>User</code>.
   * @alias module:QMApi/model/User
   * @class
   ...
   * @param {module:QMApi/model/User} obj Optional instance to populate.
   * @return {module:QMApi/model/User} The populated <code>User</code> instance.
   */
