...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QMApi.UserTag = factory(root.QMApi.ApiClient);
  }
   ...
   * @module QMApi/model/UserTag
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>UserTag</code>.
   * @alias module:QMApi/model/UserTag
   * @class
   ...
   * @param {module:QMApi/model/UserTag} obj Optional instance to populate.
   * @return {module:QMApi/model/UserTag} The populated <code>UserTag</code> instance.
   */
