...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['QMApi/ApiClient', 'QMApi/model/UserTokenRequestInnerUserField'], factory);
   ...
   * @module QMApi/model/UserTokenRequest
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>UserTokenRequest</code>.
   * @alias module:QMApi/model/UserTokenRequest
   * @class
   ...
   * @param {module:QMApi/model/UserTokenRequest} obj Optional instance to populate.
   * @return {module:QMApi/model/UserTokenRequest} The populated <code>UserTokenRequest</code> instance.
   */
  ...
  /**
   * @member {module:QMApi/model/UserTokenRequestInnerUserField} user
   */
