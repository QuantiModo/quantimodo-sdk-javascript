...
(function(root, factory) {
   ...
   * @module QMApi/model/UserVariableDelete
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>UserVariableDelete</code>.
   * @alias module:QMApi/model/UserVariableDelete
   * @class
   ...
   * @param {module:QMApi/model/UserVariableDelete} obj Optional instance to populate.
   * @return {module:QMApi/model/UserVariableDelete} The populated <code>UserVariableDelete</code> instance.
   */
