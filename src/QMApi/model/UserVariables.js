...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['QMApi/ApiClient', 'QMApi/model/UserVariable'], factory);
   ...
   * @module QMApi/model/UserVariables
   * @version 5.8.725
   */
   ...
   * @alias module:QMApi/model/UserVariables
   * @class
   * @extends Array
   */
   ...
   * @param {module:QMApi/model/UserVariables} obj Optional instance to populate.
   * @return {module:QMApi/model/UserVariables} The populated <code>UserVariables</code> instance.
   */
