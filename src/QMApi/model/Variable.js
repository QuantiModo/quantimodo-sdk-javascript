...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['QMApi/ApiClient', 'QMApi/model/Variable'], factory);
   ...
   * @module QMApi/model/Variable
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>Variable</code>.
   * @alias module:QMApi/model/Variable
   * @class
   ...
   * @param combinationOperation {module:QMApi/model/Variable.CombinationOperationEnum} Way to aggregate measurements over time. Options are \"MEAN\" or \"SUM\". SUM should be used for things like minutes of exercise.  If you use MEAN for exercise, then a person might exercise more minutes in one day but add separate measurements that were smaller.  So when we are doing correlational analysis, we would think that the person exercised less that day even though they exercised more.  Conversely, we must use MEAN for things such as ratings which cannot be SUMMED.
   ...
   * @param joinedVariables {Array.<module:QMApi/model/Variable>} Array of Variables that are joined with this Variable
   * @param parent {Number} Id of the parent variable if this variable has any parent
   * @param subVariables {Array.<module:QMApi/model/Variable>} Array of Variables that are sub variables to this Variable
   ...
   * @param {module:QMApi/model/Variable} obj Optional instance to populate.
   * @return {module:QMApi/model/Variable} The populated <code>Variable</code> instance.
   */
   ...
   * @member {module:QMApi/model/Variable.CombinationOperationEnum} combinationOperation
   */
   ...
   * @member {Array.<module:QMApi/model/Variable>} joinedVariables
   */
   ...
   * @member {Array.<module:QMApi/model/Variable>} subVariables
   */
