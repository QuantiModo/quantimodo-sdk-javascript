...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QMApi.Vote = factory(root.QMApi.ApiClient);
  }
   ...
   * @module QMApi/model/Vote
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>Vote</code>.
   * @alias module:QMApi/model/Vote
   * @class
   ...
   * @param {module:QMApi/model/Vote} obj Optional instance to populate.
   * @return {module:QMApi/model/Vote} The populated <code>Vote</code> instance.
   */
