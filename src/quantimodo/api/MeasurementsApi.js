...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodo/ApiClient', 'quantimodo/model/CommonResponse', 'quantimodo/model/Measurement', 'quantimodo/model/MeasurementDelete', 'quantimodo/model/MeasurementSet', 'quantimodo/model/MeasurementUpdate', 'quantimodo/model/Pairs'], factory);
   ...
   * @module quantimodo/api/MeasurementsApi
   * @version 5.8.725
   */

  /**
   * Constructs a new MeasurementsApi. 
   * @alias module:quantimodo/api/MeasurementsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:quantimodo/api/MeasurementsApi~deleteMeasurementCallback
     ...
     * @param {module:quantimodo/model/MeasurementDelete} body The startTime and variableId of the measurement to be deleted.
     * @param {module:quantimodo/api/MeasurementsApi~deleteMeasurementCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:quantimodo/api/MeasurementsApi~getMeasurementsCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodo/model/Measurement} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodo/api/MeasurementsApi~getMeasurementsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodo/model/Measurement}
     */
     ...
     * @callback module:quantimodo/api/MeasurementsApi~getPairsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodo/model/Pairs>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.offset OFFSET says to skip that many rows before beginning to return rows to the client. OFFSET 0 is the same as omitting the OFFSET clause.If both OFFSET and LIMIT appear, then OFFSET rows are skipped before starting to count the LIMIT rows that are returned.
     * @param {String} opts.sort Sort by one of the listed field names. If the field name is prefixed with &#x60;-&#x60;, it will sort in descending order.
     * @param {module:quantimodo/api/MeasurementsApi~getPairsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodo/model/Pairs>}
     */
     ...
     * @callback module:quantimodo/api/MeasurementsApi~measurementExportRequestCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodo/api/MeasurementsApi~measurementExportRequestCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:quantimodo/api/MeasurementsApi~postMeasurementsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Array.<module:quantimodo/model/MeasurementSet>} body An array of measurement sets containing measurement items you want to insert.
     * @param {Object} opts Optional parameters
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodo/api/MeasurementsApi~postMeasurementsCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodo/api/MeasurementsApi~v1MeasurementsUpdatePutCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodo/model/CommonResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Delete a previously submitted measurement
     * @param {module:quantimodo/model/MeasurementUpdate} body The id as well as the new startTime, note, and/or value of the measurement to be updated
     * @param {module:quantimodo/api/MeasurementsApi~v1MeasurementsUpdatePutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodo/model/CommonResponse}
     */
