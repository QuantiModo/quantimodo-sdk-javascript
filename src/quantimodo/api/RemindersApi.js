...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodo/ApiClient', 'quantimodo/model/CommonResponse', 'quantimodo/model/InlineResponse200', 'quantimodo/model/InlineResponse2001', 'quantimodo/model/InlineResponse2002', 'quantimodo/model/TrackingReminder', 'quantimodo/model/TrackingReminderDelete', 'quantimodo/model/TrackingReminderNotificationPost'], factory);
  ...
  /**
   * Reminders service.
   * @module quantimodo/api/RemindersApi
   * @version 5.8.725
   */

  /**
   * Constructs a new RemindersApi. 
   * @alias module:quantimodo/api/RemindersApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:quantimodo/api/RemindersApi~deleteTrackingReminderCallback
     ...
     * @param {module:quantimodo/model/TrackingReminderDelete} body Id of reminder to be deleted
     * @param {Object} opts Optional parameters
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodo/api/RemindersApi~deleteTrackingReminderCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:quantimodo/api/RemindersApi~getTrackingReminderNotificationsCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodo/model/InlineResponse2002} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodo/api/RemindersApi~getTrackingReminderNotificationsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodo/model/InlineResponse2002}
     */
     ...
     * @callback module:quantimodo/api/RemindersApi~getTrackingRemindersCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodo/model/InlineResponse200} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.offset OFFSET says to skip that many rows before beginning to return rows to the client. OFFSET 0 is the same as omitting the OFFSET clause.If both OFFSET and LIMIT appear, then OFFSET rows are skipped before starting to count the LIMIT rows that are returned.
     * @param {String} opts.sort Sort by one of the listed field names. If the field name is prefixed with &#x60;-&#x60;, it will sort in descending order.
     * @param {module:quantimodo/api/RemindersApi~getTrackingRemindersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodo/model/InlineResponse200}
     */
     ...
     * @callback module:quantimodo/api/RemindersApi~postTrackingReminderNotificationsCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodo/model/CommonResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Snooze, skip, or track a pending tracking reminder notification
     * @param {Array.<module:quantimodo/model/TrackingReminderNotificationPost>} body Id of the pending reminder to be snoozed
     * @param {Object} opts Optional parameters
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodo/api/RemindersApi~postTrackingReminderNotificationsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodo/model/CommonResponse}
     */
     ...
     * @callback module:quantimodo/api/RemindersApi~postTrackingRemindersCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodo/model/InlineResponse2001} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodo/model/TrackingReminder} opts.body TrackingReminder that should be stored
     * @param {module:quantimodo/api/RemindersApi~postTrackingRemindersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodo/model/InlineResponse2001}
     */
