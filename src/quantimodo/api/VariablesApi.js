...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodo/ApiClient', 'quantimodo/model/CommonResponse', 'quantimodo/model/UserTag', 'quantimodo/model/UserVariableDelete', 'quantimodo/model/UserVariables', 'quantimodo/model/Variable', 'quantimodo/model/VariableCategory'], factory);
  ...
  /**
   * Variables service.
   * @module quantimodo/api/VariablesApi
   * @version 5.8.725
   */

  /**
   * Constructs a new VariablesApi. 
   * @alias module:quantimodo/api/VariablesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:quantimodo/api/VariablesApi~deleteUserTagCallback
     ...
     * @param {module:quantimodo/api/VariablesApi~deleteUserTagCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:quantimodo/api/VariablesApi~deleteUserVariableCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:quantimodo/model/UserVariableDelete} variableId Id of the variable whose measurements should be deleted
     * @param {module:quantimodo/api/VariablesApi~deleteUserVariableCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodo/api/VariablesApi~getPublicVariablesCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodo/model/Variable} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodo/api/VariablesApi~getPublicVariablesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodo/model/Variable}
     */
     ...
     * @callback module:quantimodo/api/VariablesApi~getUserVariablesCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodo/model/Variable} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.offset OFFSET says to skip that many rows before beginning to return rows to the client. OFFSET 0 is the same as omitting the OFFSET clause.If both OFFSET and LIMIT appear, then OFFSET rows are skipped before starting to count the LIMIT rows that are returned.
     * @param {String} opts.sort Sort by one of the listed field names. If the field name is prefixed with &#x60;-&#x60;, it will sort in descending order.
     * @param {module:quantimodo/api/VariablesApi~getUserVariablesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodo/model/Variable}
     */
     ...
     * @callback module:quantimodo/api/VariablesApi~getVariableCategoriesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodo/model/VariableCategory>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodo/api/VariablesApi~getVariableCategoriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodo/model/VariableCategory>}
     */
     ...
     * @callback module:quantimodo/api/VariablesApi~postUserTagsCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodo/model/CommonResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodo/model/UserTag} body Contains the new user tag data
     * @param {Object} opts Optional parameters
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodo/api/VariablesApi~postUserTagsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodo/model/CommonResponse}
     */
     ...
     * @callback module:quantimodo/api/VariablesApi~postUserVariablesCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodo/model/UserVariables} userVariables Variable user settings data
     * @param {module:quantimodo/api/VariablesApi~postUserVariablesCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodo/api/VariablesApi~resetUserVariableSettingsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Reset user settings for a variable to defaults
     * @param {module:quantimodo/model/UserVariableDelete} variableId Id of the variable that should be reset
     * @param {module:quantimodo/api/VariablesApi~resetUserVariableSettingsCallback} callback The callback function, accepting three arguments: error, data, response
     */
