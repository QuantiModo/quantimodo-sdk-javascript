...
(function(root, factory) {
   ...
   * @module quantimodo/model/ConnectorInstruction
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>ConnectorInstruction</code>.
   * @alias module:quantimodo/model/ConnectorInstruction
   * @class
   */
   ...
   * @param {module:quantimodo/model/ConnectorInstruction} obj Optional instance to populate.
   * @return {module:quantimodo/model/ConnectorInstruction} The populated <code>ConnectorInstruction</code> instance.
   */
