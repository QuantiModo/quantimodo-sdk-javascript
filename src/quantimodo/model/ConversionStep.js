...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QMApi.ConversionStep = factory(root.QMApi.ApiClient);
  }
   ...
   * @module quantimodo/model/ConversionStep
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>ConversionStep</code>.
   * @alias module:quantimodo/model/ConversionStep
   * @class
   * @param operation {module:quantimodo/model/ConversionStep.OperationEnum} ADD or MULTIPLY
   ...
   * @param {module:quantimodo/model/ConversionStep} obj Optional instance to populate.
   * @return {module:quantimodo/model/ConversionStep} The populated <code>ConversionStep</code> instance.
   */
  ...
  /**
   * ADD or MULTIPLY
   * @member {module:quantimodo/model/ConversionStep.OperationEnum} operation
   */
