...
(function(root, factory) {
   ...
   * @module quantimodo/model/Correlation
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>Correlation</code>.
   * @alias module:quantimodo/model/Correlation
   * @class
   ...
   * @param {module:quantimodo/model/Correlation} obj Optional instance to populate.
   * @return {module:quantimodo/model/Correlation} The populated <code>Correlation</code> instance.
   */
