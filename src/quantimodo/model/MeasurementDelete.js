...
(function(root, factory) {
   ...
   * @module quantimodo/model/MeasurementDelete
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>MeasurementDelete</code>.
   * @alias module:quantimodo/model/MeasurementDelete
   * @class
   ...
   * @param {module:quantimodo/model/MeasurementDelete} obj Optional instance to populate.
   * @return {module:quantimodo/model/MeasurementDelete} The populated <code>MeasurementDelete</code> instance.
   */
