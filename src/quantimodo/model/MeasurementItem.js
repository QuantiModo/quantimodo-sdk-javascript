...
(function(root, factory) {
   ...
   * @module quantimodo/model/MeasurementItem
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>MeasurementItem</code>.
   * @alias module:quantimodo/model/MeasurementItem
   * @class
   ...
   * @param {module:quantimodo/model/MeasurementItem} obj Optional instance to populate.
   * @return {module:quantimodo/model/MeasurementItem} The populated <code>MeasurementItem</code> instance.
   */
