...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodo/ApiClient', 'quantimodo/model/MeasurementItem'], factory);
   ...
   * @module quantimodo/model/MeasurementSet
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>MeasurementSet</code>.
   * @alias module:quantimodo/model/MeasurementSet
   * @class
   * @param measurementItems {Array.<module:quantimodo/model/MeasurementItem>} Array of timestamps, values, and optional notes
   ...
   * @param {module:quantimodo/model/MeasurementSet} obj Optional instance to populate.
   * @return {module:quantimodo/model/MeasurementSet} The populated <code>MeasurementSet</code> instance.
   */
   ...
   * @member {Array.<module:quantimodo/model/MeasurementItem>} measurementItems
   */
   ...
   * @member {module:quantimodo/model/MeasurementSet.CombinationOperationEnum} combinationOperation
   */
