...
(function(root, factory) {
   ...
   * @module quantimodo/model/PostCorrelation
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>PostCorrelation</code>.
   * @alias module:quantimodo/model/PostCorrelation
   * @class
   ...
   * @param {module:quantimodo/model/PostCorrelation} obj Optional instance to populate.
   * @return {module:quantimodo/model/PostCorrelation} The populated <code>PostCorrelation</code> instance.
   */
