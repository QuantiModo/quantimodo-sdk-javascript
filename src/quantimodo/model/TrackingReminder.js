...
(function(root, factory) {
   ...
   * @module quantimodo/model/TrackingReminder
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>TrackingReminder</code>.
   * @alias module:quantimodo/model/TrackingReminder
   * @class
   ...
   * @param {module:quantimodo/model/TrackingReminder} obj Optional instance to populate.
   * @return {module:quantimodo/model/TrackingReminder} The populated <code>TrackingReminder</code> instance.
   */
   ...
   * @member {module:quantimodo/model/TrackingReminder.CombinationOperationEnum} combinationOperation
   */
