...
(function(root, factory) {
   ...
   * @module quantimodo/model/TrackingReminderDelete
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>TrackingReminderDelete</code>.
   * @alias module:quantimodo/model/TrackingReminderDelete
   * @class
   ...
   * @param {module:quantimodo/model/TrackingReminderDelete} obj Optional instance to populate.
   * @return {module:quantimodo/model/TrackingReminderDelete} The populated <code>TrackingReminderDelete</code> instance.
   */
