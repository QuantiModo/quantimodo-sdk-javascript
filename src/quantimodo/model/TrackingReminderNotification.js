...
(function(root, factory) {
   ...
   * @module quantimodo/model/TrackingReminderNotification
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>TrackingReminderNotification</code>.
   * @alias module:quantimodo/model/TrackingReminderNotification
   * @class
   ...
   * @param {module:quantimodo/model/TrackingReminderNotification} obj Optional instance to populate.
   * @return {module:quantimodo/model/TrackingReminderNotification} The populated <code>TrackingReminderNotification</code> instance.
   */
   ...
   * @member {module:quantimodo/model/TrackingReminderNotification.CombinationOperationEnum} combinationOperation
   */
