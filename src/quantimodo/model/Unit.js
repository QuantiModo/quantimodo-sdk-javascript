...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodo/ApiClient', 'quantimodo/model/ConversionStep'], factory);
    ...
    root.QMApi.Unit = factory(root.QMApi.ApiClient, root.QMApi.ConversionStep);
  }
   ...
   * @module quantimodo/model/Unit
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>Unit</code>.
   * @alias module:quantimodo/model/Unit
   * @class
   * @param name {String} Unit name
   * @param abbreviatedName {String} Unit abbreviation
   * @param category {module:quantimodo/model/Unit.CategoryEnum} Unit category
   * @param conversionSteps {Array.<module:quantimodo/model/ConversionStep>} Conversion steps list
   */
   ...
   * @param {module:quantimodo/model/Unit} obj Optional instance to populate.
   * @return {module:quantimodo/model/Unit} The populated <code>Unit</code> instance.
   */
  ...
  /**
   * Unit category
   * @member {module:quantimodo/model/Unit.CategoryEnum} category
   */
   ...
   * @member {Array.<module:quantimodo/model/ConversionStep>} conversionSteps
   */
