...
(function(root, factory) {
   ...
   * @module quantimodo/model/User
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>User</code>.
   * @alias module:quantimodo/model/User
   * @class
   ...
   * @param {module:quantimodo/model/User} obj Optional instance to populate.
   * @return {module:quantimodo/model/User} The populated <code>User</code> instance.
   */
