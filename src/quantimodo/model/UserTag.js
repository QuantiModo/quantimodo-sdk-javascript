...
(function(root, factory) {
   ...
   * @module quantimodo/model/UserTag
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>UserTag</code>.
   * @alias module:quantimodo/model/UserTag
   * @class
   ...
   * @param {module:quantimodo/model/UserTag} obj Optional instance to populate.
   * @return {module:quantimodo/model/UserTag} The populated <code>UserTag</code> instance.
   */
