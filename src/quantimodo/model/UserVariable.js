...
(function(root, factory) {
   ...
   * @module quantimodo/model/UserVariable
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>UserVariable</code>.
   * @alias module:quantimodo/model/UserVariable
   * @class
   ...
   * @param {module:quantimodo/model/UserVariable} obj Optional instance to populate.
   * @return {module:quantimodo/model/UserVariable} The populated <code>UserVariable</code> instance.
   */
