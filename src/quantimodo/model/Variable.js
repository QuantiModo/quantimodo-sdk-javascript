...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodo/ApiClient', 'quantimodo/model/Variable'], factory);
   ...
   * @module quantimodo/model/Variable
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>Variable</code>.
   * @alias module:quantimodo/model/Variable
   * @class
   ...
   * @param combinationOperation {module:quantimodo/model/Variable.CombinationOperationEnum} Way to aggregate measurements over time. Options are \"MEAN\" or \"SUM\". SUM should be used for things like minutes of exercise.  If you use MEAN for exercise, then a person might exercise more minutes in one day but add separate measurements that were smaller.  So when we are doing correlational analysis, we would think that the person exercised less that day even though they exercised more.  Conversely, we must use MEAN for things such as ratings which cannot be SUMMED.
   ...
   * @param joinedVariables {Array.<module:quantimodo/model/Variable>} Array of Variables that are joined with this Variable
   * @param parent {Number} Id of the parent variable if this variable has any parent
   * @param subVariables {Array.<module:quantimodo/model/Variable>} Array of Variables that are sub variables to this Variable
   ...
   * @param {module:quantimodo/model/Variable} obj Optional instance to populate.
   * @return {module:quantimodo/model/Variable} The populated <code>Variable</code> instance.
   */
   ...
   * @member {module:quantimodo/model/Variable.CombinationOperationEnum} combinationOperation
   */
   ...
   * @member {Array.<module:quantimodo/model/Variable>} joinedVariables
   */
   ...
   * @member {Array.<module:quantimodo/model/Variable>} subVariables
   */
