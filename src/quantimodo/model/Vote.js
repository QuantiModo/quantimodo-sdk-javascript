...
(function(root, factory) {
   ...
   * @module quantimodo/model/Vote
   * @version 5.8.725
   */

  /**
   * Constructs a new <code>Vote</code>.
   * @alias module:quantimodo/model/Vote
   * @class
   ...
   * @param {module:quantimodo/model/Vote} obj Optional instance to populate.
   * @return {module:quantimodo/model/Vote} The populated <code>Vote</code> instance.
   */
