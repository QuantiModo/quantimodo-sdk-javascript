...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/CommonResponse
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>CommonResponse</code>.
   * @alias module:quantimodoApi/quantimodoApi/CommonResponse
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/CommonResponse} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/CommonResponse} The populated <code>CommonResponse</code> instance.
   */
