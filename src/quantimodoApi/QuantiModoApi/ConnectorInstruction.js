...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/ConnectorInstruction
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>ConnectorInstruction</code>.
   * @alias module:quantimodoApi/quantimodoApi/ConnectorInstruction
   * @class
   */
   ...
   * @param {module:quantimodoApi/quantimodoApi/ConnectorInstruction} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/ConnectorInstruction} The populated <code>ConnectorInstruction</code> instance.
   */
