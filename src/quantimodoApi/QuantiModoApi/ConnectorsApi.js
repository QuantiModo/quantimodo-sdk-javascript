...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodoApi/ApiClient', 'quantimodoApi/quantimodoApi/Connector', 'quantimodoApi/quantimodoApi/ConnectorInfo', 'quantimodoApi/quantimodoApi/ConnectorInstruction'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../quantimodoApi/Connector'), require('../quantimodoApi/ConnectorInfo'), require('../quantimodoApi/ConnectorInstruction'));
  } else {
  ...
  /**
   * Connectors service.
   * @module quantimodoApi/QuantiModoApi/ConnectorsApi
   * @version 5.8.724
   */

  /**
   * Constructs a new ConnectorsApi. 
   * @alias module:quantimodoApi/QuantiModoApi/ConnectorsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectMobileGetCallback
     ...
     * @param {module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectMobileGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsConnectorNameConnectGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsConnectorNameConnectGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsConnectorNameConnectInstructionsGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsConnectorNameConnectInstructionsGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsConnectorNameConnectParameterGetCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodoApi/quantimodoApi/ConnectorInstruction} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsConnectorNameConnectParameterGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodoApi/quantimodoApi/ConnectorInstruction}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsConnectorNameDisconnectGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} connectorName Lowercase system name of the source application or device. Get a list of available connectors from the /v1/connectors/list endpoint.
     * @param {module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsConnectorNameDisconnectGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsConnectorNameInfoGetCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodoApi/quantimodoApi/ConnectorInfo} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsConnectorNameInfoGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodoApi/quantimodoApi/ConnectorInfo}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsConnectorNameUpdateGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsConnectorNameUpdateGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsListGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/Connector>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1ConnectorsListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/Connector>}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1IntegrationJsGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {module:quantimodoApi/QuantiModoApi/ConnectorsApi~v1IntegrationJsGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
