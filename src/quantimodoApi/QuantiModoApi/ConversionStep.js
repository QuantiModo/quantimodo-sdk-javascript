...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/ConversionStep
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>ConversionStep</code>.
   * @alias module:quantimodoApi/quantimodoApi/ConversionStep
   * @class
   * @param operation {module:quantimodoApi/quantimodoApi/ConversionStep.OperationEnum} ADD or MULTIPLY
   ...
   * @param {module:quantimodoApi/quantimodoApi/ConversionStep} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/ConversionStep} The populated <code>ConversionStep</code> instance.
   */
  ...
  /**
   * ADD or MULTIPLY
   * @member {module:quantimodoApi/quantimodoApi/ConversionStep.OperationEnum} operation
   */
