...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/Correlation
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>Correlation</code>.
   * @alias module:quantimodoApi/quantimodoApi/Correlation
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/Correlation} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/Correlation} The populated <code>Correlation</code> instance.
   */
