...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodoApi/ApiClient', 'quantimodoApi/quantimodoApi/CommonResponse', 'quantimodoApi/quantimodoApi/Correlation', 'quantimodoApi/quantimodoApi/JsonErrorResponse', 'quantimodoApi/quantimodoApi/PostCorrelation', 'quantimodoApi/quantimodoApi/PostVote', 'quantimodoApi/quantimodoApi/VoteDelete'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../quantimodoApi/CommonResponse'), require('../quantimodoApi/Correlation'), require('../quantimodoApi/JsonErrorResponse'), require('../quantimodoApi/PostCorrelation'), require('../quantimodoApi/PostVote'), require('../quantimodoApi/VoteDelete'));
  } else {
   ...
   * @module quantimodoApi/QuantiModoApi/CorrelationsApi
   * @version 5.8.724
   */

  /**
   * Constructs a new CorrelationsApi. 
   * @alias module:quantimodoApi/QuantiModoApi/CorrelationsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1AggregatedCorrelationsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/Correlation>} data The data returned by the service call.
     ...
     * @param {module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1AggregatedCorrelationsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/Correlation>}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1AggregatedCorrelationsPostCallback
     * @param {String} error Error message, if any.
     ...
     * Add correlation
     * @param {module:quantimodoApi/quantimodoApi/PostCorrelation} body Provides correlation data
     * @param {Object} opts Optional parameters
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1AggregatedCorrelationsPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1CorrelationsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/Correlation>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.sort Sort by given field. If the field is prefixed with &#x60;-, it will sort in descending order.
     * @param {Boolean} opts.outcomesOfInterest Only include correlations for which the effect is an outcome of interest for the user
     * @param {module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1CorrelationsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/Correlation>}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1OrganizationsOrganizationIdUsersUserIdVariablesVariableNameCausesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/Correlation>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1OrganizationsOrganizationIdUsersUserIdVariablesVariableNameCausesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/Correlation>}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1OrganizationsOrganizationIdUsersUserIdVariablesVariableNameEffectsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/CommonResponse>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.userId User&#39;s id
     * @param {String} opts.includePublic Include public correlations, Can be \&quot;1\&quot; or empty.
     * @param {module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1OrganizationsOrganizationIdUsersUserIdVariablesVariableNameEffectsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/CommonResponse>}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1PublicCorrelationsSearchSearchGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/Correlation>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.userId User&#39;s id
     * @param {Boolean} opts.outcomesOfInterest Only include correlations for which the effect is an outcome of interest for the user
     * @param {module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1PublicCorrelationsSearchSearchGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/Correlation>}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1VariablesVariableNameCausesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/Correlation>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} variableName Effect variable name
     * @param {module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1VariablesVariableNameCausesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/Correlation>}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1VariablesVariableNameEffectsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/Correlation>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1VariablesVariableNameEffectsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/Correlation>}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1VariablesVariableNamePublicCausesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/Correlation>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1VariablesVariableNamePublicCausesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/Correlation>}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1VariablesVariableNamePublicEffectsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/Correlation>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1VariablesVariableNamePublicEffectsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/Correlation>}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1VotesDeletePostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1VotesDeletePostCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1VotesPostCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodoApi/quantimodoApi/CommonResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/CorrelationsApi~v1VotesPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodoApi/quantimodoApi/CommonResponse}
     */
