...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/JsonErrorResponse
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>JsonErrorResponse</code>.
   * @alias module:quantimodoApi/quantimodoApi/JsonErrorResponse
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/JsonErrorResponse} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/JsonErrorResponse} The populated <code>JsonErrorResponse</code> instance.
   */
