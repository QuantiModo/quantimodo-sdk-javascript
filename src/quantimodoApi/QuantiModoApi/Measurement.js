...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodoApi/ApiClient', 'quantimodoApi/quantimodoApi/HumanTime'], factory);
   ...
   * @module quantimodoApi/quantimodoApi/Measurement
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>Measurement</code>.
   * @alias module:quantimodoApi/quantimodoApi/Measurement
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/Measurement} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/Measurement} The populated <code>Measurement</code> instance.
   */
  ...
  /**
   * @member {module:quantimodoApi/quantimodoApi/HumanTime} humanTime
   */
