...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.quantimodoApi.MeasurementItem = factory(root.quantimodoApi.ApiClient);
  }
   ...
   * @module quantimodoApi/quantimodoApi/MeasurementItem
   * @version 5.0.724
   */

  /**
   * Constructs a new <code>MeasurementItem</code>.
   * @alias module:quantimodoApi/quantimodoApi/MeasurementItem
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/MeasurementItem} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/MeasurementItem} The populated <code>MeasurementItem</code> instance.
   */
