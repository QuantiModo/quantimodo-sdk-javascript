...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/MeasurementRange
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>MeasurementRange</code>.
   * @alias module:quantimodoApi/quantimodoApi/MeasurementRange
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/MeasurementRange} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/MeasurementRange} The populated <code>MeasurementRange</code> instance.
   */
