...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodoApi/ApiClient', 'quantimodoApi/quantimodoApi/ValueObject'], factory);
   ...
   * @module quantimodoApi/quantimodoApi/MeasurementSet
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>MeasurementSet</code>.
   * @alias module:quantimodoApi/quantimodoApi/MeasurementSet
   * @class
   * @param measurements {Array.<module:quantimodoApi/quantimodoApi/ValueObject>} Array of timestamps, values, and optional notes
   ...
   * @param {module:quantimodoApi/quantimodoApi/MeasurementSet} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/MeasurementSet} The populated <code>MeasurementSet</code> instance.
   */
   ...
   * @member {Array.<module:quantimodoApi/quantimodoApi/ValueObject>} measurements
   */
   ...
   * @member {module:quantimodoApi/quantimodoApi/MeasurementSet.CombinationOperationEnum} combinationOperation
   */
