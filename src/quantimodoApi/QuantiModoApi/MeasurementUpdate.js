...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/MeasurementUpdate
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>MeasurementUpdate</code>.
   * @alias module:quantimodoApi/quantimodoApi/MeasurementUpdate
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/MeasurementUpdate} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/MeasurementUpdate} The populated <code>MeasurementUpdate</code> instance.
   */
