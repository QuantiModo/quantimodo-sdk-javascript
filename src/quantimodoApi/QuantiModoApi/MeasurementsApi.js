...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodoApi/ApiClient', 'quantimodoApi/quantimodoApi/CommonResponse', 'quantimodoApi/quantimodoApi/Measurement', 'quantimodoApi/quantimodoApi/MeasurementDelete', 'quantimodoApi/quantimodoApi/MeasurementRange', 'quantimodoApi/quantimodoApi/MeasurementSet', 'quantimodoApi/quantimodoApi/MeasurementSource', 'quantimodoApi/quantimodoApi/MeasurementUpdate'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../quantimodoApi/CommonResponse'), require('../quantimodoApi/Measurement'), require('../quantimodoApi/MeasurementDelete'), require('../quantimodoApi/MeasurementRange'), require('../quantimodoApi/MeasurementSet'), require('../quantimodoApi/MeasurementSource'), require('../quantimodoApi/MeasurementUpdate'));
  } else {
   ...
   * @module quantimodoApi/QuantiModoApi/MeasurementsApi
   * @version 5.8.724
   */

  /**
   * Constructs a new MeasurementsApi. 
   * @alias module:quantimodoApi/QuantiModoApi/MeasurementsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementSourcesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodoApi/quantimodoApi/MeasurementSource} data The data returned by the service call.
     ...
     * @param {module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementSourcesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodoApi/quantimodoApi/MeasurementSource}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementSourcesPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:quantimodoApi/quantimodoApi/MeasurementSource} body An array of names of data sources you want to add.
     * @param {Object} opts Optional parameters
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementSourcesPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementsDailyGetCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodoApi/quantimodoApi/Measurement} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementsDailyGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodoApi/quantimodoApi/Measurement}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementsDeletePostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:quantimodoApi/quantimodoApi/MeasurementDelete} body The startTime and variableId of the measurement to be deleted.
     * @param {module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementsDeletePostCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodoApi/quantimodoApi/Measurement} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.offset Since the maximum limit is 200 records, to get more than that you&#39;ll have to make multiple API calls and page through the results. To retrieve all the data, you can iterate through data by using the &#x60;limit&#x60; and &#x60;offset&#x60; query parameters.  For example, if you want to retrieve data from 61-80 then you can use a query with the following parameters, &#x60;imit&#x3D;20&amp;offset&#x3D;60&#x60;.
     * @param {Number} opts.sort Sort by given field. If the field is prefixed with &#x60;-, it will sort in descending order.
     * @param {module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodoApi/quantimodoApi/Measurement}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementsPostCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodoApi/quantimodoApi/MeasurementSet} body An array of measurements you want to insert.
     * @param {Object} opts Optional parameters
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementsPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementsRangeGetCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodoApi/quantimodoApi/MeasurementRange} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementsRangeGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodoApi/quantimodoApi/MeasurementRange}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementsUpdatePostCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodoApi/quantimodoApi/CommonResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Delete a previously submitted measurement
     * @param {module:quantimodoApi/quantimodoApi/MeasurementUpdate} body The id as well as the new startTime, note, and/or value of the measurement to be updated
     * @param {module:quantimodoApi/QuantiModoApi/MeasurementsApi~v1MeasurementsUpdatePostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodoApi/quantimodoApi/CommonResponse}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/MeasurementsApi~v2MeasurementsCsvGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/MeasurementsApi~v2MeasurementsCsvGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:quantimodoApi/QuantiModoApi/MeasurementsApi~v2MeasurementsRequestCsvPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/MeasurementsApi~v2MeasurementsRequestCsvPostCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:quantimodoApi/QuantiModoApi/MeasurementsApi~v2MeasurementsRequestPdfPostCallback
     * @param {String} error Error message, if any.
     * @param {'Number'} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/MeasurementsApi~v2MeasurementsRequestPdfPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link 'Number'}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/MeasurementsApi~v2MeasurementsRequestXlsPostCallback
     * @param {String} error Error message, if any.
     * @param {'Number'} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/MeasurementsApi~v2MeasurementsRequestXlsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link 'Number'}
     */
