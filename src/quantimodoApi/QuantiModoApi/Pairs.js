...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/Pairs
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>Pairs</code>.
   * @alias module:quantimodoApi/quantimodoApi/Pairs
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/Pairs} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/Pairs} The populated <code>Pairs</code> instance.
   */
