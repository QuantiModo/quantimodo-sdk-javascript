...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/TrackingReminder
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>TrackingReminder</code>.
   * @alias module:quantimodoApi/quantimodoApi/TrackingReminder
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/TrackingReminder} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/TrackingReminder} The populated <code>TrackingReminder</code> instance.
   */
   ...
   * @member {module:quantimodoApi/quantimodoApi/TrackingReminder.CombinationOperationEnum} combinationOperation
   */
