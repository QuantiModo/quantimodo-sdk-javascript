...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/TrackingReminderDelete
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>TrackingReminderDelete</code>.
   * @alias module:quantimodoApi/quantimodoApi/TrackingReminderDelete
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/TrackingReminderDelete} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/TrackingReminderDelete} The populated <code>TrackingReminderDelete</code> instance.
   */
