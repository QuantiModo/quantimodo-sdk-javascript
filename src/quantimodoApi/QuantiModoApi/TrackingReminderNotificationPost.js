...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.quantimodoApi.TrackingReminderNotificationPost = factory(root.quantimodoApi.ApiClient);
  }
   ...
   * @module quantimodoApi/quantimodoApi/TrackingReminderNotificationPost
   * @version 5.0.724
   */

  /**
   * Constructs a new <code>TrackingReminderNotificationPost</code>.
   * @alias module:quantimodoApi/quantimodoApi/TrackingReminderNotificationPost
   * @class
   * @param id {Number} Id of the TrackingReminderNotification
   * @param action {module:quantimodoApi/quantimodoApi/TrackingReminderNotificationPost.ActionEnum} track records a measurement for the notification.  snooze changes the notification to 1 hour from now. skip deletes the notification.
   */
   ...
   * @param {module:quantimodoApi/quantimodoApi/TrackingReminderNotificationPost} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/TrackingReminderNotificationPost} The populated <code>TrackingReminderNotificationPost</code> instance.
   */
   ...
   * @member {module:quantimodoApi/quantimodoApi/TrackingReminderNotificationPost.ActionEnum} action
   */
