...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodoApi/ApiClient', 'quantimodoApi/quantimodoApi/ConversionStep'], factory);
   ...
   * @module quantimodoApi/quantimodoApi/Unit
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>Unit</code>.
   * @alias module:quantimodoApi/quantimodoApi/Unit
   * @class
   * @param name {String} Unit name
   * @param abbreviatedName {String} Unit abbreviation
   * @param category {module:quantimodoApi/quantimodoApi/Unit.CategoryEnum} Unit category
   * @param conversionSteps {Array.<module:quantimodoApi/quantimodoApi/ConversionStep>} Conversion steps list
   */
   ...
   * @param {module:quantimodoApi/quantimodoApi/Unit} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/Unit} The populated <code>Unit</code> instance.
   */
  ...
  /**
   * Unit category
   * @member {module:quantimodoApi/quantimodoApi/Unit.CategoryEnum} category
   */
   ...
   * @member {Array.<module:quantimodoApi/quantimodoApi/ConversionStep>} conversionSteps
   */
