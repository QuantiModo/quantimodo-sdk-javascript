...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodoApi/ApiClient', 'quantimodoApi/quantimodoApi/Unit', 'quantimodoApi/quantimodoApi/UnitCategory'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../quantimodoApi/Unit'), require('../quantimodoApi/UnitCategory'));
  } else {
  ...
  /**
   * Units service.
   * @module quantimodoApi/QuantiModoApi/UnitsApi
   * @version 5.8.724
   */

  /**
   * Constructs a new UnitsApi. 
   * @alias module:quantimodoApi/QuantiModoApi/UnitsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:quantimodoApi/QuantiModoApi/UnitsApi~v1UnitCategoriesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodoApi/quantimodoApi/UnitCategory} data The data returned by the service call.
     ...
     * @param {module:quantimodoApi/QuantiModoApi/UnitsApi~v1UnitCategoriesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodoApi/quantimodoApi/UnitCategory}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/UnitsApi~v1UnitsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/Unit>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodoApi/QuantiModoApi/UnitsApi~v1UnitsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/Unit>}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/UnitsApi~v1UnitsVariableGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/Unit>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodoApi/QuantiModoApi/UnitsApi~v1UnitsVariableGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/Unit>}
     */
