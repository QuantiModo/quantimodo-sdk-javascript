...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/Update
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>Update</code>.
   * @alias module:quantimodoApi/quantimodoApi/Update
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/Update} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/Update} The populated <code>Update</code> instance.
   */
