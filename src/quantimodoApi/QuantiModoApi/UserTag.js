...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/UserTag
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>UserTag</code>.
   * @alias module:quantimodoApi/quantimodoApi/UserTag
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/UserTag} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/UserTag} The populated <code>UserTag</code> instance.
   */
