...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/UserTokenFailedResponse
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>UserTokenFailedResponse</code>.
   * @alias module:quantimodoApi/quantimodoApi/UserTokenFailedResponse
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/UserTokenFailedResponse} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/UserTokenFailedResponse} The populated <code>UserTokenFailedResponse</code> instance.
   */
