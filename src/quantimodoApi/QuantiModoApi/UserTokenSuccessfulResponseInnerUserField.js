...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/UserTokenSuccessfulResponseInnerUserField
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>UserTokenSuccessfulResponseInnerUserField</code>.
   * @alias module:quantimodoApi/quantimodoApi/UserTokenSuccessfulResponseInnerUserField
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/UserTokenSuccessfulResponseInnerUserField} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/UserTokenSuccessfulResponseInnerUserField} The populated <code>UserTokenSuccessfulResponseInnerUserField</code> instance.
   */
