...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/UserVariable
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>UserVariable</code>.
   * @alias module:quantimodoApi/quantimodoApi/UserVariable
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/UserVariable} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/UserVariable} The populated <code>UserVariable</code> instance.
   */
