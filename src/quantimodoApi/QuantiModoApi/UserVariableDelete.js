...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/UserVariableDelete
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>UserVariableDelete</code>.
   * @alias module:quantimodoApi/quantimodoApi/UserVariableDelete
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/UserVariableDelete} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/UserVariableDelete} The populated <code>UserVariableDelete</code> instance.
   */
