...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/UserVariableRelationship
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>UserVariableRelationship</code>.
   * @alias module:quantimodoApi/quantimodoApi/UserVariableRelationship
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/UserVariableRelationship} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/UserVariableRelationship} The populated <code>UserVariableRelationship</code> instance.
   */
