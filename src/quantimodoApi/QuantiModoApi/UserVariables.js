...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/UserVariables
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>UserVariables</code>.
   * @alias module:quantimodoApi/quantimodoApi/UserVariables
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/UserVariables} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/UserVariables} The populated <code>UserVariables</code> instance.
   */
