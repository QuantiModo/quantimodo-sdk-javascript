...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodoApi/ApiClient', 'quantimodoApi/quantimodoApi/Variable'], factory);
   ...
   * @module quantimodoApi/quantimodoApi/Variable
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>Variable</code>.
   * @alias module:quantimodoApi/quantimodoApi/Variable
   * @class
   ...
   * @param combinationOperation {module:quantimodoApi/quantimodoApi/Variable.CombinationOperationEnum} Way to aggregate measurements over time. Options are \"MEAN\" or \"SUM\". SUM should be used for things like minutes of exercise.  If you use MEAN for exercise, then a person might exercise more minutes in one day but add separate measurements that were smaller.  So when we are doing correlational analysis, we would think that the person exercised less that day even though they exercised more.  Conversely, we must use MEAN for things such as ratings which cannot be SUMMED.
   ...
   * @param joinedVariables {Array.<module:quantimodoApi/quantimodoApi/Variable>} Array of Variables that are joined with this Variable
   * @param parent {Number} Id of the parent variable if this variable has any parent
   * @param subVariables {Array.<module:quantimodoApi/quantimodoApi/Variable>} Array of Variables that are sub variables to this Variable
   ...
   * @param {module:quantimodoApi/quantimodoApi/Variable} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/Variable} The populated <code>Variable</code> instance.
   */
   ...
   * @member {module:quantimodoApi/quantimodoApi/Variable.CombinationOperationEnum} combinationOperation
   */
   ...
   * @member {Array.<module:quantimodoApi/quantimodoApi/Variable>} joinedVariables
   */
   ...
   * @member {Array.<module:quantimodoApi/quantimodoApi/Variable>} subVariables
   */
