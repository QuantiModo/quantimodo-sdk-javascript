...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/VariableCategory
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>VariableCategory</code>.
   * @alias module:quantimodoApi/quantimodoApi/VariableCategory
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/VariableCategory} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/VariableCategory} The populated <code>VariableCategory</code> instance.
   */
