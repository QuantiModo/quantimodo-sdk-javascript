...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['quantimodoApi/ApiClient', 'quantimodoApi/quantimodoApi/UserVariableDelete', 'quantimodoApi/quantimodoApi/UserVariables', 'quantimodoApi/quantimodoApi/Variable', 'quantimodoApi/quantimodoApi/VariableCategory', 'quantimodoApi/quantimodoApi/VariablesNew'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../quantimodoApi/UserVariableDelete'), require('../quantimodoApi/UserVariables'), require('../quantimodoApi/Variable'), require('../quantimodoApi/VariableCategory'), require('../quantimodoApi/VariablesNew'));
  } else {
  ...
  /**
   * Variables service.
   * @module quantimodoApi/QuantiModoApi/VariablesApi
   * @version 5.8.724
   */

  /**
   * Constructs a new VariablesApi. 
   * @alias module:quantimodoApi/QuantiModoApi/VariablesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:quantimodoApi/QuantiModoApi/VariablesApi~v1PublicVariablesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodoApi/quantimodoApi/Variable} data The data returned by the service call.
     ...
     * @param {module:quantimodoApi/QuantiModoApi/VariablesApi~v1PublicVariablesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodoApi/quantimodoApi/Variable}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/VariablesApi~v1PublicVariablesSearchSearchGetCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodoApi/quantimodoApi/Variable} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.offset Since the maximum limit is 200 records, to get more than that you&#39;ll have to make multiple API calls and page through the results. To retrieve all the data, you can iterate through data by using the &#x60;limit&#x60; and &#x60;offset&#x60; query parameters.  For example, if you want to retrieve data from 61-80 then you can use a query with the following parameters, &#x60;imit&#x3D;20&amp;offset&#x3D;60&#x60;.
     * @param {Number} opts.sort Sort by given field. If the field is prefixed with &#x60;-, it will sort in descending order.
     * @param {module:quantimodoApi/QuantiModoApi/VariablesApi~v1PublicVariablesSearchSearchGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodoApi/quantimodoApi/Variable}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/VariablesApi~v1UserVariablesDeletePostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:quantimodoApi/quantimodoApi/UserVariableDelete} variableId Id of the variable whose measurements should be deleted
     * @param {module:quantimodoApi/QuantiModoApi/VariablesApi~v1UserVariablesDeletePostCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/VariablesApi~v1UserVariablesPostCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodoApi/quantimodoApi/UserVariables} userVariables Variable user settings data
     * @param {module:quantimodoApi/QuantiModoApi/VariablesApi~v1UserVariablesPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/VariablesApi~v1UserVariablesResetPostCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Reset user settings for a variable to defaults
     * @param {module:quantimodoApi/quantimodoApi/UserVariableDelete} variableId Id of the variable that should be reset
     * @param {module:quantimodoApi/QuantiModoApi/VariablesApi~v1UserVariablesResetPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/VariablesApi~v1VariableCategoriesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/VariableCategory>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodoApi/QuantiModoApi/VariablesApi~v1VariableCategoriesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/VariableCategory>}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/VariablesApi~v1VariablesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodoApi/quantimodoApi/Variable} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.offset Since the maximum limit is 200 records, to get more than that you&#39;ll have to make multiple API calls and page through the results. To retrieve all the data, you can iterate through data by using the &#x60;limit&#x60; and &#x60;offset&#x60; query parameters.  For example, if you want to retrieve data from 61-80 then you can use a query with the following parameters, &#x60;imit&#x3D;20&amp;offset&#x3D;60&#x60;.
     * @param {Number} opts.sort Sort by given field. If the field is prefixed with &#x60;-, it will sort in descending order.
     * @param {module:quantimodoApi/QuantiModoApi/VariablesApi~v1VariablesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodoApi/quantimodoApi/Variable}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/VariablesApi~v1VariablesPostCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:quantimodoApi/quantimodoApi/VariablesNew} body Original name for the variable.
     * @param {Object} opts Optional parameters
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/VariablesApi~v1VariablesPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/VariablesApi~v1VariablesSearchSearchGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:quantimodoApi/quantimodoApi/Variable>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.limit The LIMIT is used to limit the number of results returned. So if you have 1000 results, but only want to the first 10, you would set this to 10 and offset to 0.
     * @param {Number} opts.offset Since the maximum limit is 200 records, to get more than that you&#39;ll have to make multiple API calls and page through the results. To retrieve all the data, you can iterate through data by using the &#x60;limit&#x60; and &#x60;offset&#x60; query parameters.  For example, if you want to retrieve data from 61-80 then you can use a query with the following parameters, &#x60;imit&#x3D;20&amp;offset&#x3D;60&#x60;.
     * @param {module:quantimodoApi/QuantiModoApi/VariablesApi~v1VariablesSearchSearchGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:quantimodoApi/quantimodoApi/Variable>}
     */
     ...
     * @callback module:quantimodoApi/QuantiModoApi/VariablesApi~v1VariablesVariableNameGetCallback
     * @param {String} error Error message, if any.
     * @param {module:quantimodoApi/quantimodoApi/Variable} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.accessToken User&#39;s OAuth2 access token
     * @param {Number} opts.userId User&#39;s id
     * @param {module:quantimodoApi/QuantiModoApi/VariablesApi~v1VariablesVariableNameGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:quantimodoApi/quantimodoApi/Variable}
     */
