...
(function(root, factory) {
   ...
   * @module quantimodoApi/quantimodoApi/VoteDelete
   * @version 5.8.724
   */

  /**
   * Constructs a new <code>VoteDelete</code>.
   * @alias module:quantimodoApi/quantimodoApi/VoteDelete
   * @class
   ...
   * @param {module:quantimodoApi/quantimodoApi/VoteDelete} obj Optional instance to populate.
   * @return {module:quantimodoApi/quantimodoApi/VoteDelete} The populated <code>VoteDelete</code> instance.
   */
