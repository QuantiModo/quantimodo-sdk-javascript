...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QMApi.ConnectorsApi();
  });
  ...
  describe('ConnectorsApi', function() {
    ...
    describe('connectConnectorWithParameters', function() {
      it('should call connectConnectorWithParameters successfully', function(done) {
        //uncomment below and update the code to test connectConnectorWithParameters
        //instance.connectConnectorWithParameters(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
