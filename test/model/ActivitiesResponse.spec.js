...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Quantimodo.ActivitiesResponse();
  });
  ...
  describe('ActivitiesResponse', function() {
    it('should create an instance of ActivitiesResponse', function() {
      // uncomment below and update the code to test ActivitiesResponse
      //var instance = new Quantimodo.ActivitiesResponse();
      //expect(instance).to.be.a(Quantimodo.ActivitiesResponse);
    });
