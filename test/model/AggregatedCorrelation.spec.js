...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Quantimodo.AggregatedCorrelation();
  });
  ...
  describe('AggregatedCorrelation', function() {
    it('should create an instance of AggregatedCorrelation', function() {
      // uncomment below and update the code to test AggregatedCorrelation
      //var instane = new Quantimodo.AggregatedCorrelation();
      //expect(instance).to.be.a(Quantimodo.AggregatedCorrelation);
    });
