...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Quantimodo.FriendsResponse();
  });
  ...
  describe('FriendsResponse', function() {
    it('should create an instance of FriendsResponse', function() {
      // uncomment below and update the code to test FriendsResponse
      //var instance = new Quantimodo.FriendsResponse();
      //expect(instance).to.be.a(Quantimodo.FriendsResponse);
    });
