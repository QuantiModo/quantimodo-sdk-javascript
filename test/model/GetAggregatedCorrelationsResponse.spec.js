...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Quantimodo.GetAggregatedCorrelationsResponse();
  });
  ...
  describe('GetAggregatedCorrelationsResponse', function() {
    it('should create an instance of GetAggregatedCorrelationsResponse', function() {
      // uncomment below and update the code to test GetAggregatedCorrelationsResponse
      //var instane = new Quantimodo.GetAggregatedCorrelationsResponse();
      //expect(instance).to.be.a(Quantimodo.GetAggregatedCorrelationsResponse);
    });
