...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Quantimodo.GetPairsResponse();
  });
  ...
  describe('GetPairsResponse', function() {
    it('should create an instance of GetPairsResponse', function() {
      // uncomment below and update the code to test GetPairsResponse
      //var instane = new Quantimodo.GetPairsResponse();
      //expect(instance).to.be.a(Quantimodo.GetPairsResponse);
    });
