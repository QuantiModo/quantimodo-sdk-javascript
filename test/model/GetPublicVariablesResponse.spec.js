...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Quantimodo.GetPublicVariablesResponse();
  });
  ...
  describe('GetPublicVariablesResponse', function() {
    it('should create an instance of GetPublicVariablesResponse', function() {
      // uncomment below and update the code to test GetPublicVariablesResponse
      //var instane = new Quantimodo.GetPublicVariablesResponse();
      //expect(instance).to.be.a(Quantimodo.GetPublicVariablesResponse);
    });
