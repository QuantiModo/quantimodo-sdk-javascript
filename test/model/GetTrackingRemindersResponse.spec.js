...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Quantimodo.GetTrackingRemindersResponse();
  });
  ...
  describe('GetTrackingRemindersResponse', function() {
    it('should create an instance of GetTrackingRemindersResponse', function() {
      // uncomment below and update the code to test GetTrackingRemindersResponse
      //var instane = new Quantimodo.GetTrackingRemindersResponse();
      //expect(instance).to.be.a(Quantimodo.GetTrackingRemindersResponse);
    });
