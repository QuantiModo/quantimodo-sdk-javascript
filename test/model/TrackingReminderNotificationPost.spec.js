...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new quantimodoApi.TrackingReminderNotificationPost();
  });
  ...
  describe('TrackingReminderNotificationPost', function() {
    it('should create an instance of TrackingReminderNotificationPost', function() {
      ...
      //var instane = new quantimodoApi.TrackingReminderNotificationPost();
      //expect(instance).to.be.a(quantimodoApi.TrackingReminderNotificationPost);
    });
