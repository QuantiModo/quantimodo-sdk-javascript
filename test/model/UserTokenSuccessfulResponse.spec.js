...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new quantimodoApi.UserTokenSuccessfulResponse();
  });
  ...
  describe('UserTokenSuccessfulResponse', function() {
    it('should create an instance of UserTokenSuccessfulResponse', function() {
      ...
      //var instane = new quantimodoApi.UserTokenSuccessfulResponse();
      //expect(instance).to.be.a(quantimodoApi.UserTokenSuccessfulResponse);
    });
