...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QMApi.UserTokenSuccessfulResponseInnerUserField();
  });
  ...
  describe('UserTokenSuccessfulResponseInnerUserField', function() {
    it('should create an instance of UserTokenSuccessfulResponseInnerUserField', function() {
      ...
      //var instane = new QMApi.UserTokenSuccessfulResponseInnerUserField();
      //expect(instance).to.be.a(QMApi.UserTokenSuccessfulResponseInnerUserField);
    });
