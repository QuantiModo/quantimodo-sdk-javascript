...
(function(root, factory) {
  ...
  describe('YAxi', function() {
    it('should create an instance of YAxi', function() {
      // uncomment below and update the code to test YAxi
      //var instane = new Quantimodo.YAxi();
      //expect(instance).to.be.a(Quantimodo.YAxi);
    });
    ...
    it('should have the property opposite (base name: "opposite")', function() {
      // uncomment below and update the code to test the property opposite
      //var instane = new Quantimodo.YAxi();
      //expect(instance).to.be();
    });
